...
SECRET_KEY = 'django-insecure-##z4w8l7)#ht8&5yp9h!g^&&x0e=+)g-^l(-@jj-msjehi9ajl'
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://postgres:P7JMQQiSAdhFoPbk@db.gqaoicqumkeynntmpjwa.supabase.co:5432/postgres',
        conn_max_age=600,
    )
}
